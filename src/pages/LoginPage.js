...
function LoginPage() {
  return (
    ...
    <a href="https://github.com/cachemoney-3000/pokefi" class="rounded-full w-12 h-12 bg-gray-400 fixed bottom-0 right-0 flex items-center justify-center text-gray-800 mr-8 mb-8 shadow-sm duration-300 ease-in-out transform hover:scale-110" target="_blank" rel="noreferrer">
